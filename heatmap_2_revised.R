...
heatmap.2_revised <- function (x, 
    ...
    if (missing(lmat) || is.null(lmat)) {
        ...
        if (!missing(ColSideColors)) {
            ...
            lhei=c(lhei[1], lcm(side.height.fraction*NumColSideColors), lhei[2])
        }
        ...
        if (!missing(RowSideColors)) {
            ...
            lwid <- c(lwid[1], lcm(side.height.fraction*NumRowSideColors), lwid[2])
        }
        lmat[is.na(lmat)] <- 0
    }
